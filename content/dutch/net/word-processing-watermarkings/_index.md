...
### [Voeg watermerk toe met teksteffecten in Word-documenten](./add-watermark-text-effects-word-docs/)
...
### [Vervang vormtekst door opgemaakte tekst in Word-documenten](./replace-shape-text-formatted-text-word-docs/)
