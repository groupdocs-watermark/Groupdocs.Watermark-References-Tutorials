...
1. **هل يمكنني استخدام GroupDocs.Watermark لتنسيقات ملفات أخرى؟**  
   نعم، تدعم مجموعة واسعة من أنواع المستندات بخلاف المخططات، بما في ذلك PDF، DOCX، PPTX، وغيرها.  
...
3. **كيف يمكنني إزالة علامة مائية من مخطط؟**  
   توفر المكتبة واجهات كشف وإزالة العلامات المائية؛ راجع الوثائق الرسمية للحصول على التفاصيل.  
4. **هل يمكن إضافة علامات مائية نصية إلى جميع الصفحات أو إلى صفحات مختارة فقط؟**  
   يمكنك ضبط `DiagramShapeWatermarkOptions` لاستهداف صفحات أو أشكال معينة.  
5. **ماذا أفعل إذا لم تظهر العلامة المائية كما هو متوقع؟**  
   تحقق من إعدادات الموضع، تباين لون الخط، وتأكد من حفظ الملف بعد إضافة العلامة المائية.  
