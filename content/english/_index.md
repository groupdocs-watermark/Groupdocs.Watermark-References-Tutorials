---
title: Complete Guide to Document Watermarking with GroupDocs.Watermark
linktitle: GroupDocs.Watermark Tutorials & Examples
additionalTitle: GroupDocs API References for Document Watermarking
description: Explore and master comprehensive document watermarking with GroupDocs.Watermark tutorials for .NET & Java. Learn how to implement professional document security, digital branding, and advanced watermarking features with step‑by‑step guides.
...
- [Getting Started]({{< relref "net/getting-started" >}}) - Initial setup, installation, and licensing guides
- [Document Loading & Saving]({{< relref "net/document-loading-saving" >}}) - Efficient techniques for handling documents
- [Text Watermarks]({{< relref "net/text-watermarks" >}}) - Add customizable text-based watermarks with formatting options
- [Image Watermarks]({{< relref "net/image-watermarks" >}}) - Implement logo watermarks and visual branding elements
- [PDF Document Watermarking]({{< relref "net/pdf-document-watermarking" >}}) - Specialized techniques for PDF security
- [Word Processing Document Watermarking]({{< relref "net/word-processing-document-watermarking" >}}) - Microsoft Word document protection strategies
- [Presentation Document Watermarking]({{< relref "net/presentation-document-watermarking" >}}) - PowerPoint slide security solutions
- [Spreadsheet Document Watermarking]({{< relref "net/spreadsheet-document-watermarking" >}}) - Excel document branding methods
- [Email Document Watermarking]({{< relref "net/email-document-watermarking" >}}) - Secure email attachments and content
- [Diagram Document Watermarking]({{< relref "net/diagram-document-watermarking" >}}) - Visio and diagram file protection
- [Watermark Search & Modification]({{< relref "net/watermark-search-modification" >}}) - Find and update existing watermarks
- [Watermark Removal]({{< relref "net/watermark-removal" >}}) - Clean unwanted or outdated watermarks
- [Advanced Features]({{< relref "net/advanced-features" >}}) - Specialized protection techniques and document preview
- [Document Information]({{< relref "net/document-information" >}}) - Extract metadata for intelligent watermarking
- [Licensing & Configuration]({{< relref "net/licensing-configuration" >}}) - Proper setup for production environments
...
- [Getting Started]({{< relref "java/getting-started" >}}) - Quick introduction and setup for Java developers
- [Document Loading & Saving]({{< relref "java/document-loading-saving" >}}) - Efficient document handling in Java
- [Text Watermarks]({{< relref "java/text-watermarks" >}}) - Implement text-based watermarks with custom formatting
- [Image Watermarks]({{< relref "java/image-watermarks" >}}) - Add logo watermarks and visual branding elements
- [PDF Document Watermarking]({{< relref "java/pdf-document-watermarking" >}}) - PDF-specific watermarking techniques
- [Word Processing Document Watermarking]({{< relref "java/word-processing-document-watermarking" >}}) - Secure Word documents effectively
- [Presentation Document Watermarking]({{< relref "java/presentation-document-watermarking" >}}) - PowerPoint presentation protection
- [Spreadsheet Document Watermarking]({{< relref "java/spreadsheet-document-watermarking" >}}) - Excel spreadsheet security methods
- [Email Document Watermarking]({{< relref "java/email-document-watermarking" >}}) - Email message and attachment security
- [Diagram Document Watermarking]({{< relref "java/diagram-document-watermarking" >}}) - Protect Visio and diagram files
- [Watermark Search & Modification]({{< relref "java/watermark-search-modification" >}}) - Discover and update existing watermarks
- [Watermark Removal]({{< relref "java/watermark-removal" >}}) - Remove unwanted watermarks programmatically
- [Advanced Features]({{< relref "java/advanced-features" >}}) - Enhanced protection and security techniques
- [Document Information]({{< relref "java/document-information" >}}) - Analyze documents for smart watermarking
- [Licensing & Configuration]({{< relref "java/licensing-configuration" >}}) - Implementation in production environments
